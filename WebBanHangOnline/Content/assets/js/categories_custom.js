...
jQuery(document).ready(function($)
{
	...
	*/
    ...
    function initPriceSlider()
    {
		...
		//$("#amount").val("đ" + $("#slider-range").slider("values", 0).toLocaleString() +
		//	" - đ" + $("#slider-range").slider("values", 1).toLocaleString());
		$("#amount").val(
			"đ" + $("#slider-range").slider("values", 0).toLocaleString('vi-VN') +
			" - đ" + $("#slider-range").slider("values", 1).toLocaleString('vi-VN'));
    }
